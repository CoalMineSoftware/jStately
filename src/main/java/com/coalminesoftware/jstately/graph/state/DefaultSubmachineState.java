...
/**
 * Basic {@link SubmachineState} implementation that provides the given StateGraph when a state
 * machine enters the state and sets up the state machine that will evaluate the SubmachineState's
 * graph.
 */
